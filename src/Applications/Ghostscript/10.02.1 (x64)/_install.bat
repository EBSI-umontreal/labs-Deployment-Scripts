...
START /WAIT "" "%~dp07z.exe" x -y -x!"$PLUGINSDIR" -x!"*.nsis" -x!"vcredist*" -o"%destinationFolder%" "%~dp0gs10021w64.exe"
START /WAIT "" "%~dp07z.exe" x -y -ir!"Identity-UTF16-H" -o"%destinationFolder% "%~dp0gs10021w64.exe"
