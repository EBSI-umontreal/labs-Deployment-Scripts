...
START /WAIT "" "%~dp07z.exe" x -y  -o"%destinationFolder%" "%~dp0yEd-3.23.2.zip"
...
cscript "%~dp0shortcut.vbs" "%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\yEd Graph Editor\yEd Graph Editor 3.23.2.lnk" "%PROGRAMFILES%\yWorks\yEd\yEd.exe"
