...
START /WAIT msiexec.exe /qn /norestart /i "%~dp0calibre-64bit-7.1.0.msi"
...
RENAME "%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\calibre 64bit - E-book Management" "calibre 7.1.0"
