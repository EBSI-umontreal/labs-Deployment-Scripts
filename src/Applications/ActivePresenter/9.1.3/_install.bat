...
START /WAIT "" "%~dp0ActivePresenter_v9.1.3_setup.exe" /VERYSILENT /NORESTART
...
RENAME "%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\ActivePresenter" "ActivePresenter 9.1.3"
