...
START /WAIT "" "%~dp0MediaInfo_GUI_24.06_Windows.exe" /S
...
cscript "%~dp0shortcut-v2.vbs" "%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\MediaInfo\MediaInfo 24.06.lnk" "%ProgramFiles%\MediaInfo\MediaInfo.exe"
