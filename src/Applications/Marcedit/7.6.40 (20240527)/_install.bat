...
START /WAIT "" "%~dp0windowsdesktop-runtime-6.0.32-win-x86.exe" /install /quiet /norestart
START /WAIT "" "%~dp0windowsdesktop-runtime-6.0.32-win-x64.exe" /install /quiet /norestart
