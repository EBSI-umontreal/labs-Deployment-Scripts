...
MOVE /Y "%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\Docs par Archifiltre (next).lnk" "%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\Archifiltre"
...
del "%PUBLIC%\Desktop\Docs par Archifiltre (next).lnk" /F
