...
START /WAIT "" "%~dp07z.exe" x "%~dp0VeraPDF-1.26.2.zip" -o"%PROGRAMFILES(X86)%" -aoa
...
cscript "%~dp0shortcut-v2.vbs" "%PROGRAMDATA%\Microsoft\Windows\Start Menu\Programs\veraPDF\veraPDF GUI 1.26.2.lnk" "%PROGRAMFILES(X86)%\verapdf\verapdf-gui.bat"
