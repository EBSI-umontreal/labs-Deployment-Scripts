...
Dim strComputer, strSRVName, strPrinterName, strIPAdr, strDriverName, strDriverInfPath, strPrinterLocation, strPrinterDescription
...
MapLPRPrinter "PaperCut Global PostScript", ".\PC-Global-Print-Driver\", "PCGlobal.inf", "libreservice.sium.umontreal.ca", "libreservice.sium.umontreal.ca", "Noir", "SIUM", "Appareils N&B"
MapLPRPrinter "PaperCut Global PostScript", ".\PC-Global-Print-Driver\", "PCGlobal.inf", "libreservice.sium.umontreal.ca", "libreservice.sium.umontreal.ca", "Couleur", "SIUM", "Appareils couleur"
